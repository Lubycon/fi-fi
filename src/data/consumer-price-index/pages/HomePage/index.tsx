...
const HomePage = () => {
  ...
  return (
    <Layout pageTitle="실시간 한미 소비자물가지수(CPI) 보기">
      ...
      <Txt as="p">
        물가지수는 물건의 가격이 과거에 비해 얼마나 올랐나 조사 한 것이예요.
        <br />
        <br />
        물가지수는 대표적으로
        <br />
        ...
        <br />
        3). 소비자들이 일상 생활을 하는데 있어 중요한 141개의 물건 가격을 조사한 <strong>생활물가지수</strong>
        <br />
        ...
        지표들 중 하나예요.
        <br />
        각 나라의 중앙은행은 기준금리를 조정하여 적정 인플레이션을 유지하려고 노력하고있어요. 그래서 중앙은행들은
        물가지표들을 예의주시하고있죠.
        <br />
        <br />
        기준금리가 오르면, 기존에 은행으로부터 돈을 빌렸던 기업의 이자부담과 늘어나게되요. 같은 맥락으로 신규대출의 이자
        또한 비싸지기 때문에 자금을 조달하기 어려워지죠.
        <br />
        기업들은 자금을 조달해 설비를 확충하거나 신규사업에 적극적으로 투자하여 매출을 올려야하는데, 자금조달과 부채에
        대한 부담이 증가해 투자에 소극적이되요.
        <br />
        투자에 소극적이 된 기업은 매출이 안 좋아질 확률이 높을거예요. 기업 매출이 시장이 기대하던 것 보다 악화되면, 이는
        바로 주식가격의 하락으로 이어져요.
        <br />
        <br />
